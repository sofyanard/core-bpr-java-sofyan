...
public class FasilitasKreditService {
	...
	public List<FasilitasKredit> customEodCalculation1003(String unitId, String strDate) {
		return fasilitasKreditRepository.customEodCalculation1003(unitId, strDate);
	}
