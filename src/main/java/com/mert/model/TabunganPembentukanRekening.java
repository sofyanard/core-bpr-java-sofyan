...
public class TabunganPembentukanRekening{
	@Id
	@Column(name="no_rekg")
	...
	private Double current_saldo;
	
	@Column(name="last_month_saldo")
	private Double last_month_saldo;
	...
	public void setCurrent_saldo(Double current_saldo) {
		this.current_saldo = current_saldo;
	}

	public Double getLast_month_saldo() {
		return last_month_saldo;
	}

	public void setLast_month_saldo(Double last_month_saldo) {
		this.last_month_saldo = last_month_saldo;
	}

	//constructor
	public TabunganPembentukanRekening() { };
